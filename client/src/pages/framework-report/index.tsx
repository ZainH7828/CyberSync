        ...
        <Row>
          <Col lg={12}>
            <div className={"section-1"}>
              <div className={"content-sec"}>
                <div className={"heading"}>
                  <h3>Framework Report generation</h3>
                  <p>
                ...
                {/* <div className={"tags"}>
                  <span>Framework function: All Frameworks</span>
            ...
            <div className="container-inline">
              {reportShow &&
                Object.entries(reportData?.transformedStatus).map(
                  ([key, value]) => (
                    <div key={key}>
                      <h3 className={"heading-f"} id="heading-b">
                        {key}
                      </h3>
                      <ReportChart data={value} />
                    </div>
                  )
                )}
              {/* <div>
